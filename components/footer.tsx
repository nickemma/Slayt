    ...
    <footer className="border-t border-border" id="footer">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          {/* Why Slayt? */}
          <div>
            <h4 className="mb-4 text-sm font-bold text-navy">{"Why Slayt?"}</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="mb-4 text-sm font-bold text-navy">Support</h4>
            <ul className="flex flex-col gap-3">
              {support.map((item) => (
                <li key={item.label}>
                  <Link
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {[
              ...
              {
                label: "Facebook",
                href: "https://www.facebook.com/share/1DpxxU3VTD/?mibextid=wwXlfr",
                path: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z",
              },
              {
                label: "Instagram",
                href: "https://www.instagram.com/slayt3131?igsh=NTNsdXR2MXFhNGNq&utm_source=qr",
