...
// import slayt from "@/images/Frame-logo.png";
// import other from "@/images/Frame-other.png";
...
//         >
//           {/* Header */}
//           <div className="grid grid-cols-3 gap-2 border-b border-border px-6 py-4">
...
//                 width={120}
//                 height={80}
//                 className="mx-auto mt-1 w-8 h-auto"
//               />
//             </span>
//             <span className="text-center">
//               <Image
